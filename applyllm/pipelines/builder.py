...
"""
    ...
    def get_model_info(cls, model_name) -> 'ModelInfo':
        ...
        if model_name.startswith(cls.META_FAMILY):
            model_info = ModelInfo(cls.META_FAMILY, cls.INST_MSG_MAP[cls.META_FAMILY], cls.INST_MSG_ENDING)
        elif model_name.startswith(cls.MISTRAL_FAMILY):
            model_info = ModelInfo(cls.MISTRAL_FAMILY, cls.INST_MSG_MAP[cls.MISTRAL_FAMILY], cls.INST_MSG_ENDING)
        else:
